...
export const ApplicationStatus: React.FC = () => {
  ...
  > = {
    ...
    interview_completed: {
      ...
      description: "Interview completed. Awaiting decision from the company",
    },
    offer_given: {
      icon: FileText,
    ...
    offer_accepted: {
      ...
      description: "Offer accepted! Welcome to your new role",
    },
    rejected: {
      icon: Clock,
  ...
  return (
    <div className="space-y-6">
      ...
      {candidateApplications.length === 0 ? (
        ...
        <div className="space-y-6">
          {candidateApplications.map((application: Application) => {
                      ...
                      {[
                        ...
                        return (
                          ...
                          >
                            ...
                            {index < 5 && (
                              <div
                                className={`absolute top-5 left-12 w-24 h-0.5 ${
